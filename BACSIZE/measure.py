...
def SkeletonMeasure(Skeleton:np.array,Distances:np.array,pixsize:float=33.02/512):
...
def SizeDataFrame(maskfilelist:list, from_paths:bool=True)->pd.DataFrame:
    ...
    Args:
        ...
        from_paths(bool): If True, assumes that the masks are to be read first
