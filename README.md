...
Repository to access the different notebooks and information of the paper [Deep-learning deconvolution and segmentation of fluorescent membranes for high precision bacterial cell size profiling](https://www.nature.com/articles/s42003-026-10303-y)
...
- [Main article](https://www.nature.com/articles/s42003-026-10303-y) Reyes-Matte, M., Fortmann-Grote, C., Gericke, B., Hüttman, N., Ojkic, N., & Lopez-Garrido, J. (2026). Deep-learning deconvolution and segmentation of fluorescent membranes for high precision bacterial cell size profiling
